...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/Nur4ik00p/jexactyl-installer"}
...
welcome() {
  ...
  print_brake 70
  output "Jexactyl panel installation script @ $SCRIPT_RELEASE"
  output ""
  output "Copyright (C) 2018 - 2024, Vilhelm Prytz, <vilhelm@prytznet.se>"
  output "https://github.com/Nur4ik00p/jexactyl-installer"
  output ""
  output "This script is not associated with the official Pterodactyl Project."
  output ""
  output "Running $OS version $OS_VER."
  if [ "$1" == "panel" ]; then
    output "Latest jexactyl/panel is $PTERODACTYL_PANEL_VERSION"
  elif [ "$1" == "wings" ]; then
    output "Latest jexactyl/wings is $PTERODACTYL_WINGS_VERSION"
  fi
  print_brake 70
}
...
get_latest_versions() {
  ...
  PTERODACTYL_PANEL_VERSION=$(get_latest_release "jexactyl/panel")
  PTERODACTYL_WINGS_VERSION=$(get_latest_release "jexactyl/wings")
}
