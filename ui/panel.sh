...
main() {
  ...
  if [ -d "/var/www/jexactyl" ]; then
    warning "The script has detected that you already have Jexactyl panel on your system! You cannot run the script multiple times, it will fail!"
...
summary() {
  print_brake 62
  output "Jexactyl panel $PTERODACTYL_PANEL_VERSION with nginx on $OS"
